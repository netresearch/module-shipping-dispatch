...
/**
 * POST action controller, removes selected packages from a dispatch.
 */
class Unassign extends Action implements HttpPostActionInterface
{
    /**
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            $this->packageAssignment->unassign($dispatchId, $trackIds);
